  ...
  multiDataSet[0].data = cadastros.map((cadastro, index) => {
    return (
      [
        ...
        {value: cadastro.setor.dre.sigla, style: ((index === 0 || (index % 2) === 0) ? data_styles_1 : data_styles_2)},
        {value: cadastro.setor.distrito.nome, style: ((index === 0 || (index % 2) === 0) ? data_styles_1 : data_styles_2)},
        {value: cadastro.setor.codigo, style: ((index === 0 || (index % 2) === 0) ? data_styles_1 : data_styles_2)},
        {value: `B1: ${cadastro.demandaimovel.bercario_i} - B2: ${cadastro.demandaimovel.bercario_ii} - MG1: ${cadastro.demandaimovel.mini_grupo_i} - MG2: ${cadastro.demandaimovel.mini_grupo_i}`, style: ((index === 0 || (index % 2) === 0) ? data_styles_1 : data_styles_2)},
